...
<figure><img src="../../.gitbook/assets/image (29).png" alt="" width="375"><figcaption><p>示意图 1</p></figcaption></figure>

然后，拿掉其中一个位置。比如这个 `r2c7`。

<figure><img src="../../.gitbook/assets/image (30).png" alt="" width="375"><figcaption><p>示意图 2</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (31).png" alt="" width="375"><figcaption><p>示意图 3</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (32).png" alt="" width="375"><figcaption><p>示意图 4</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (33).png" alt="" width="375"><figcaption><p>8 个单元格的闭环</p></figcaption></figure>

如图所示。这只是 8 个单元格形成闭环的其中一种特殊摆放形式。不是说 8 个单元格必须摆成这样。这里要拿这个特殊摆放形式举例。

这个摆放你认为它形成闭环的方式是什么呢？还能只用行和列吗？似乎不行。如果只用行列连线的话，看起来就会有两个闭环了：

<figure><img src="../../.gitbook/assets/image (34).png" alt="" width="375"><figcaption><p>8 个单元格的闭环的连线（错误）</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (35).png" alt="" width="375"><figcaption><p>8 个单元格的闭环的连线（正确）</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (36).png" alt="" width="375"><figcaption><p>扭转后的 8 个单元格</p></figcaption></figure>

这样扭转不会改变用的行列宫的数量。因为它横纵并未发生变化；而扭转也不会超出宫的范畴，所以宫的数量也不变。不过，连线会稍微变一下。

<figure><img src="../../.gitbook/assets/image (37).png" alt="" width="375"><figcaption><p>扭转后的 8 个单元格的闭环连线</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (192).png" alt=""><figcaption><p>两种结构的涂色结果</p></figcaption></figure>
