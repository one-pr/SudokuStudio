...
public sealed partial class LibrarySettingPage : Page
{
	...
	{
		var libPref = Application.CurrentApp.Preference.LibraryPreferences;
	...
	private void CandidateDisplayingComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
		=> Application.CurrentApp.Preference.LibraryPreferences.LibraryCandidatesVisibility = (LibraryCandidatesVisibility)CandidateDisplayingComboBox.SelectedIndex;
}
