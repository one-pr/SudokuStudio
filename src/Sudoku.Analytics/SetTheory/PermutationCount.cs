...
/// Instances of this type will be returned by method <see cref="PatternReasoner.GetAssignmentsCount(in Pattern)"/>.
/// </summary>
...
/// <seealso cref="PatternReasoner.GetAssignmentsCount(in Pattern)"/>
